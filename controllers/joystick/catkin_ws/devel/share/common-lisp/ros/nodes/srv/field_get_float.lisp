...
(cl:defmethod cl:initialize-instance :after ((m <field_get_float-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_float-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_get_float-request> is deprecated: use nodes-srv:field_get_float-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_get_float-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_float-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_get_float-response> is deprecated: use nodes-srv:field_get_float-response instead.")))
