...
(cl:defmethod cl:initialize-instance :after ((m <robot_set_mode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_set_mode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<robot_set_mode-request> is deprecated: use nodes-srv:robot_set_mode-request instead.")))

(cl:ensure-generic-function 'arg-val :lambda-list '(m))
(cl:defmethod arg-val ((m <robot_set_mode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nodes-srv:arg-val is deprecated.  Use nodes-srv:arg instead.")
  (arg m))
...
(cl:defmethod cl:initialize-instance :after ((m <robot_set_mode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_set_mode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<robot_set_mode-response> is deprecated: use nodes-srv:robot_set_mode-response instead.")))
