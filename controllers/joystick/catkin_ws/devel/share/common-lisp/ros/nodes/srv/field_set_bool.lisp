...
(cl:defmethod cl:initialize-instance :after ((m <field_set_bool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_set_bool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_set_bool-request> is deprecated: use nodes-srv:field_set_bool-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_set_bool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_set_bool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_set_bool-response> is deprecated: use nodes-srv:field_set_bool-response instead.")))
