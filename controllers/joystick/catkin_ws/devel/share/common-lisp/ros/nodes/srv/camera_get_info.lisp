...
(cl:defmethod cl:initialize-instance :after ((m <camera_get_info-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'camera_get_info-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<camera_get_info-request> is deprecated: use nodes-srv:camera_get_info-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<camera_get_info-request>)))
  ...
  "c2fc2a5a100c439ef9bdd511a6287c65")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'camera_get_info-request)))
  "Returns md5sum for a message object of type 'camera_get_info-request"
  "c2fc2a5a100c439ef9bdd511a6287c65")
...
(cl:defmethod cl:initialize-instance :after ((m <camera_get_info-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'camera_get_info-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<camera_get_info-response> is deprecated: use nodes-srv:camera_get_info-response instead.")))
...
(cl:defmethod Fov-val ((m <camera_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nodes-srv:Fov-val is deprecated.  Use nodes-srv:Fov instead.")
  (Fov m))

(cl:ensure-generic-function 'nearRange-val :lambda-list '(m))
(cl:defmethod nearRange-val ((m <camera_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nodes-srv:nearRange-val is deprecated.  Use nodes-srv:nearRange instead.")
  (nearRange m))

(cl:ensure-generic-function 'maxRange-val :lambda-list '(m))
(cl:defmethod maxRange-val ((m <camera_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nodes-srv:maxRange-val is deprecated.  Use nodes-srv:maxRange instead.")
  (maxRange m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<camera_get_info-response>)))
  ...
  (cl:format cl:nil "uint32 width~%uint32 height~%float64 Fov~%float64 nearRange~%float64 maxRange~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'camera_get_info-response)))
  "Returns full string definition for message of type 'camera_get_info-response"
  (cl:format cl:nil "uint32 width~%uint32 height~%float64 Fov~%float64 nearRange~%float64 maxRange~%~%~%~%"))
