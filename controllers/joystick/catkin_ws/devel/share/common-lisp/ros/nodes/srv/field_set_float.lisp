...
(cl:defmethod cl:initialize-instance :after ((m <field_set_float-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_set_float-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_set_float-request> is deprecated: use nodes-srv:field_set_float-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_set_float-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_set_float-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_set_float-response> is deprecated: use nodes-srv:field_set_float-response instead.")))
