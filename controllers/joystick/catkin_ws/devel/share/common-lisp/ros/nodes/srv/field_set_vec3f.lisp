...
(cl:defmethod cl:initialize-instance :after ((m <field_set_vec3f-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_set_vec3f-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_set_vec3f-request> is deprecated: use nodes-srv:field_set_vec3f-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_set_vec3f-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_set_vec3f-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_set_vec3f-response> is deprecated: use nodes-srv:field_set_vec3f-response instead.")))
