...
(cl:defmethod cl:initialize-instance :after ((m <field_get_node-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_node-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_get_node-request> is deprecated: use nodes-srv:field_get_node-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_get_node-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_node-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_get_node-response> is deprecated: use nodes-srv:field_get_node-response instead.")))
