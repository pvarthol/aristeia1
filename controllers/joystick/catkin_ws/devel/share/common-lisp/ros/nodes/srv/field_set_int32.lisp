...
(cl:defmethod cl:initialize-instance :after ((m <field_set_int32-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_set_int32-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_set_int32-request> is deprecated: use nodes-srv:field_set_int32-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_set_int32-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_set_int32-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_set_int32-response> is deprecated: use nodes-srv:field_set_int32-response instead.")))
