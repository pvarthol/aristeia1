...
(cl:defmethod cl:initialize-instance :after ((m <field_get_count-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_count-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_get_count-request> is deprecated: use nodes-srv:field_get_count-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_get_count-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_count-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_get_count-response> is deprecated: use nodes-srv:field_get_count-response instead.")))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <field_get_count-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nodes-srv:count-val is deprecated.  Use nodes-srv:count instead.")
  (count m))
