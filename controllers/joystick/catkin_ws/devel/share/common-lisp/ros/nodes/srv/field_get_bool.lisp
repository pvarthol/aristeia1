...
(cl:defmethod cl:initialize-instance :after ((m <field_get_bool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_bool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_get_bool-request> is deprecated: use nodes-srv:field_get_bool-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_get_bool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_bool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_get_bool-response> is deprecated: use nodes-srv:field_get_bool-response instead.")))
