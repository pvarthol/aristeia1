...
(cl:defmethod cl:initialize-instance :after ((m <field_get_type-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_type-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_get_type-request> is deprecated: use nodes-srv:field_get_type-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_get_type-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_type-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_get_type-response> is deprecated: use nodes-srv:field_get_type-response instead.")))
