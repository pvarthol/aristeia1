...
(cl:defmethod cl:initialize-instance :after ((m <node_get_field-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_field-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<node_get_field-request> is deprecated: use nodes-srv:node_get_field-request instead.")))
...
(cl:defmethod fieldName-val ((m <node_get_field-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nodes-srv:fieldName-val is deprecated.  Use nodes-srv:fieldName instead.")
  (fieldName m))
...
(cl:defmethod cl:initialize-instance :after ((m <node_get_field-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_field-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<node_get_field-response> is deprecated: use nodes-srv:node_get_field-response instead.")))
