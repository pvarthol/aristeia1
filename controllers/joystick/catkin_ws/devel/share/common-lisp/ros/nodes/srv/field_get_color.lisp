...
(cl:defmethod cl:initialize-instance :after ((m <field_get_color-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_color-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_get_color-request> is deprecated: use nodes-srv:field_get_color-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_get_color-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_color-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodes-srv:<field_get_color-response> is deprecated: use nodes-srv:field_get_color-response instead.")))
