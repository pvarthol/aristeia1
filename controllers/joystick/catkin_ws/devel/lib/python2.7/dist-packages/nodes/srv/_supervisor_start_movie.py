"""autogenerated by genpy from nodes/supervisor_start_movieRequest.msg. Do not edit."""
import sys
...
class supervisor_start_movieRequest(genpy.Message):
  _md5sum = "6002a2a6b3b34251dd3d092b3750f050"
  _type = "nodes/supervisor_start_movieRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(supervisor_start_movieRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genpy from nodes/supervisor_start_movieResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class supervisor_start_movieResponse(genpy.Message):
  _md5sum = "0b13460cb14006d3852674b4c614f25f"
  _type = "nodes/supervisor_start_movieResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(supervisor_start_movieResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class supervisor_start_movie(object):
  _type          = 'nodes/supervisor_start_movie'
  _md5sum = '96ca298eece1e7a6fe756c404839bdcc'
  _request_class  = supervisor_start_movieRequest
  _response_class = supervisor_start_movieResponse
