"""autogenerated by genpy from nodes/camera_get_infoRequest.msg. Do not edit."""
import sys
...
class camera_get_infoRequest(genpy.Message):
  ...
  _type = "nodes/camera_get_infoRequest"
...
"""autogenerated by genpy from nodes/camera_get_infoResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class camera_get_infoResponse(genpy.Message):
  _md5sum = "a856f591f91bb00e4b8e0c1b108e0f32"
  _type = "nodes/camera_get_infoResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  __slots__ = ['width','height','Fov','nearRange','maxRange']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       width,height,Fov,nearRange,maxRange
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2I3d.pack(_x.width, _x.height, _x.Fov, _x.nearRange, _x.maxRange))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(_x))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(_x))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.width, _x.height, _x.Fov, _x.nearRange, _x.maxRange,) = _struct_2I3d.unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class camera_get_info(object):
  _type          = 'nodes/camera_get_info'
  _md5sum = 'c2fc2a5a100c439ef9bdd511a6287c65'
